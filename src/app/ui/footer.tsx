...
const navLinks = [
  ...
  { name: 'Testimony', ref: 'testimonyRef' },
  { name: 'FAQs', ref: 'faqRef' },
]

const socialLinks = [
  {
    svg: '/instagram_logo.svg',
    alt: 'Instagram Link',
    link: 'https://www.instagram.com/crcl_ny',
  }
  // {
  //   svg: '/twitter_logo.svg',
  //   alt: 'Twitter Link',
  ...
  return (
    <section className="py-10 bg-gray-50 sm:pt-16 lg:pt-24">
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        ...
        <p className="text-sm text-center text-gray-600">© Copyright 2024, All Rights Reserved by CRCL</p>
      </div>
    </section>
